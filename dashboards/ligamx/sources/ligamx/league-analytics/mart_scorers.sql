...
--
-- Liga MX has no player-level fact table — no appearances, no ratings, no
-- minutes — so this is built from the event stream, which does name the scorer
-- on every goal and runs complete from 2020/21 Apertura. It is enough for a
