"""Render the La Liga raster icons from the same geometry as static/icon.svg.
...
# linearGradient id="es": x1 0% y1 100% -> x2 100% y2 0% (bottom-left to top-right)
# Flag red ramped through orange to flag gold - the two Spanish flag colours.
STOPS = [(0.00, (0xAA, 0x15, 0x1B)),
         (0.55, (0xDE, 0x7A, 0x0E)),
         (1.00, (0xF1, 0xBF, 0x00))]


def gradient(n):
    """The es gradient painted across an n x n square."""
