...
-- relegation groups after the regular rounds; La Liga does not split, so
...
base AS (
    ...
    WHERE p.league_sk = (SELECT league_sk FROM superligaen.gold.dim_league WHERE league_id = 119924)  -- La Liga only
