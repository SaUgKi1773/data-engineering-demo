...
<script>
  ...
  // Every stat row renders whether or not the feed recorded it. The deep stats
  // effectively start in 2025/26, so an older match shows an em dash rather
  // than a 0, which would read as "this team made no tackles".
  const val  = (v) => (v == null ? '–' : v);
  const val2 = (v) => (v == null ? '–' : Number(v).toFixed(2));
</script>

```sql mc
select *
from turkey.mart_match_results
...
<div class="rounded-xl border border-gray-200 bg-white p-6 mt-2">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      ...
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_goals)}</div>
    </div>
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val2(mc[0]?.home_xg)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Expected Goals</div>
      <div class="font-semibold text-lg text-orange-500">{val2(mc[0]?.away_xg)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_total_shots)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Total Shots</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_total_shots)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_sog)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Shots on Goal</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_sog)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_big_chances)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Big Chances</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_big_chances)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_possession)}%</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Possession</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_possession)}%</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_pass_accuracy)}%</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Pass Accuracy</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_pass_accuracy)}%</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_key_passes)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Key Passes</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_key_passes)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_crosses)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Crosses</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_crosses)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_corners)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Corners</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_corners)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      ...
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_tackles)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_interceptions)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Interceptions</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_interceptions)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_clearances)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Clearances</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_clearances)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_saves)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Saves</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_saves)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_fouls)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Fouls</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_fouls)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2 border-b border-gray-100">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_yc)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Yellow Cards</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_yc)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
  ...
  <div class="py-2">
    <div class="grid grid-cols-3 items-center text-center mb-1.5">
      <div class="font-semibold text-lg text-blue-600">{val(mc[0]?.home_rc)}</div>
      <div class="text-gray-400 text-xs uppercase tracking-wide">Red Cards</div>
      <div class="font-semibold text-lg text-orange-500">{val(mc[0]?.away_rc)}</div>
    </div>
    <div class="flex h-1 rounded-full overflow-hidden bg-orange-400">
