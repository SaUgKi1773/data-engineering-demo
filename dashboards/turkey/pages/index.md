...
sidebar: never
hide_toc: true
title: Süper Lig Analytics — Turkish football intelligence
hide_title: true
description: Free, open analytics for the Süper Lig, the Turkish top flight — standings, match results, league and team intelligence, refreshed every night. A Krogvad Analytics Hub platform.
---
...
```sql league
select * from turkey.league_info
```
...
```sql summary
select * from turkey.mart_home_summary
```
...
<div class="relative rounded-3xl overflow-hidden shadow-lg mb-8" style="background: linear-gradient(135deg, #3d0207 0%, #a80812 45%, #e30a17 100%); font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
  <!-- pitch lines overlay -->
