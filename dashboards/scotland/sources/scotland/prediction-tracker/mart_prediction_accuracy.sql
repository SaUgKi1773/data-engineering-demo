-- Model vs. reality: every finished Premiership match that had a pre-kickoff
...
results AS (
    ...
    GROUP BY f.match_sk, m.match_id, d.date, d.season_scotland, m.match_round_number, m.match_round_name
),
baseline AS (
