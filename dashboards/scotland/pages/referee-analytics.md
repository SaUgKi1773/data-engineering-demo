...
from (
    select referee_name, season, home_team as team_name from scotland.mart_match_card
    union all
    select referee_name, season, away_team as team_name from scotland.mart_match_card
) t
where referee_name = '${inputs.referee.value}'
