...
<div class="pointer-events-none fixed top-0 left-0 z-50 h-12 w-full print:hidden">
  <div class="mx-auto flex h-full max-w-7xl items-center justify-end px-5 sm:px-6 md:px-12">
    <button
      ...
      aria-haspopup="true"
      class="pointer-events-auto rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
