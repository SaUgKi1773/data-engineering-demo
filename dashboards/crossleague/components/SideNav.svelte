  ...
  >
    ...
    <div class="flex h-14 flex-none items-center justify-between border-b border-gray-100 px-4">
      ...
      <button
        type="button"
        aria-label="Close menu"
        class="rounded-lg p-2 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
        on:click={close}
      >
        ...
        {#each group.items as item}
          ...
          <a
            ...
            class="mb-0.5 flex items-center gap-3 rounded-lg px-2.5 py-1.5 text-sm no-underline transition-colors
              {active ? 'bg-gray-100 font-semibold text-gray-900' : 'font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900'}"
          >
            {#if item.logo}
      ...
      <div class="flex items-center justify-between">
        {#each externalLinks as link}
          <a
            ...
            class="flex h-8 w-8 flex-none items-center justify-center rounded-lg text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
          >
