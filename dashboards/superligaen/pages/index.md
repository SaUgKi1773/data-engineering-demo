...
<div class="relative rounded-3xl overflow-hidden shadow-lg mb-8" style="background: linear-gradient(135deg, #4a0e18 0%, #a01325 45%, #d42a3d 100%); font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
  <!-- pitch lines overlay -->
    ...
    <div class="flex flex-col xl:flex-row items-center xl:items-center gap-3 xl:gap-5">
      ...
      <div>
        <div class="flex items-center justify-center xl:justify-start gap-2 mb-1">
          <img src="{league[0].league_country_flag}" alt="Denmark" class="h-3.5 rounded opacity-90" onerror="this.style.display='none'" />
          <span class="text-white/50 text-[11px] uppercase" style="letter-spacing: 0.14em;">Denmark</span>
        </div>
