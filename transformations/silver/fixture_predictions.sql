...
CREATE TABLE IF NOT EXISTS {db}.silver.fixture_predictions (
    fixture_id               INTEGER,
    kick_off                 TIMESTAMPTZ,
    league_id                INTEGER,
    season                   INTEGER,
    predicted_winner_id      INTEGER,
    predicted_winner_name    VARCHAR,
    predicted_winner_comment VARCHAR,
    win_or_draw              BOOLEAN,
    under_over               VARCHAR,
    predicted_goals_home     VARCHAR,
    predicted_goals_away     VARCHAR,
    advice                   VARCHAR,
    pct_home                 VARCHAR,
    pct_draw                 VARCHAR,
    pct_away                 VARCHAR,
