...
An end-to-end data engineering project for Danish football (Superligaen) — from raw API ingestion to a live analytics dashboard. Built on a fully custom Python + SQL stack.
