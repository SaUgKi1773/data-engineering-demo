...
UNION ALL
SELECT 'dim_match_event_type', expected_sk FROM (VALUES (-1), (-2)) t(expected_sk)
WHERE expected_sk NOT IN (SELECT match_event_type_sk FROM {{ ref('dim_match_event_type') }})
UNION ALL
