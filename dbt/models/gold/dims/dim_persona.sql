...
FROM (VALUES
    (1, 'Søren',    2, true,
     'Data analyst in his early 30s. Trusts only the numbers — shots, possession, big chances, pass accuracy, cards. Never calls a win ''lucky'' when the stats back it up. Precise, occasionally smug, always grounded in the actual data. Usually dives deep in numbers with detailed long analysis. Covers many metrics as a data analyst and compares individual players and team totals. Talks a lot.'),
    (2, 'Flemming', 1, true,
    ...
    (4, 'Maja',     4, true,
     'IF there are any woodwork hits or penalty misses or errors led to goal, she is super excited. Nothing in football thrills her more than when the ball hits the post or crossbar — she finds it absolutely electric. She talks about these 3 events in this match when exists. how many there were, which team was unlucky, the drama and heartbreak of it. IF there were zero woodwork hits or errors led to goal or penalty misses in this match, then she simply says "it was a good game." and NOTHING more.'),
    (5, 'Ecem',     5, true,
